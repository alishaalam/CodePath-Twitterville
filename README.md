# Project 3 - *Twitterville*

**Twitterville** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='https://github.com/alishaalam/Twitterville/blob/master/Walkthrough.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
In the `src/twitterville.models`, create the models that represent the key data to be parsed and persisted within your application.
For example, if you were connecting to Twitter, you would want a Tweet model as follows:

```java
// models/Tweet.java
package twitterville.models;
...
Open `src/twitterville/LoginActivity.java` and configure the `onLoginSuccess` method
